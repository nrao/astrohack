...
class AstrohackBeamcutFile(AstrohackBaseFile):
    ...
    def plot_beamcut_in_amplitude(
        ...
        create_and_execute_graph_from_dict(
            looping_dict=self,
            chunk_function=plot_beamcut_in_amplitude_chunk,
            param_dict=param_dict,
            key_order=["ant", "ddi"],
            parallel=parallel,
        )
    ...
    def plot_beamcut_in_attenuation(
        ...
        create_and_execute_graph_from_dict(
            looping_dict=self,
            chunk_function=plot_beamcut_in_attenuation_chunk,
            param_dict=param_dict,
            key_order=["ant", "ddi"],
            parallel=parallel,
        )
    ...
    def plot_beam_cuts_over_sky(
        ...
        create_and_execute_graph_from_dict(
            looping_dict=self,
            chunk_function=plot_cuts_in_lm_chunk,
            param_dict=param_dict,
            key_order=["ant", "ddi"],
            parallel=parallel,
        )
    ...
    def create_beam_fit_report(
        ...
        create_and_execute_graph_from_dict(
            looping_dict=self,
            chunk_function=create_report_chunk,
            param_dict=param_dict,
            key_order=["ant", "ddi"],
            parallel=parallel,
        )
