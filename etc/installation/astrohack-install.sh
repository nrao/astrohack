...
if [ -z "${yesno}" ] || [ "${yesno}" = "y" ]; then
    ...
    cp "${HOME}"/.profile "${HOME}"/.profile.copy
    {
      ...
      echo '    wget https://github.com/nrao/astrohack/raw/main/etc/locit/casa/pre-locit-script.py'
      echo '    echo Downloading astrohack locit script...'
      echo '    wget https://github.com/nrao/astrohack/raw/main/etc/locit/exec_locit.py'
      echo '    echo'
      echo '    echo Downloading astrohack export to parminator script...'
      echo '    wget https://github.com/nrao/astrohack/raw/main/etc/locit/export_to_parminator.py'
      echo '    echo'
      echo '}'
    } >> "${HOME}"/.profile
