...
class UserInteraction:
    ...
    user_inp_list = ['filename', 'field', 'refant', 'overwrite', 'confirmation_before_start']
    sep = '='
    ...
    def _init_from_user(self):
        ...
        self.confirmation_before_start = yesno('Confirm info before starting calibration?')
    ...
    def perform_beamcut_calibration(cls):
        ...
        mycal_obj = CalObject(my_obj.filename, my_obj.field, my_obj.refant, my_obj.overwrite, msger)
...
class CalObject:
    ...
    def __init__(self, msname, field, refant, overwrite, msger, first_chan=4, last_chan=60):
        self.msname = msname
        self.refant = refant
